...
```
kheeper releases start config.json --image us.kheeper.com/public/openfga:v0.4.0
```
...
kheeper releases create $ORG/$HOST:v1 \
    --image us.kheeper.com/public/openfga:v0.4.0 \
    --config-file config.json \
    --activate
```

`$ORG/$HOST:v1` is your release tag; `us.kheeper.com/public/openfga:v0.4.0` is the image it's built from.

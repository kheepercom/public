...
```
kheeper releases start config.json --image us.kheeper.com/public/openfga:v0.1.1
```
...
kheeper releases create $ORG/$HOST:v1 \
    --image us.kheeper.com/public/openfga:v0.1.1 \
    --config-file config.json \
    --activate
```

`$ORG/$HOST:v1` is your release tag; `us.kheeper.com/public/openfga:v0.1.1` is the image it's built from.

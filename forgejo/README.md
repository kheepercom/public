...
```
kheeper releases start config.json --image us.kheeper.com/public/forgejo:v0.7.0
```
...
`$ORG/$HOST:v1` is your release tag; `us.kheeper.com/public/forgejo:v0.7.0` is the image it's built from.

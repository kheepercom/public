...
```
kheeper releases start config.json --image kheeper.com/public/postgres:v0.1.0
```
...
kheeper releases create $ORG/$HOST:v1 \
    --image kheeper.com/public/postgres:v0.1.0 \
    --config-file config.json \
    --activate
```

`$ORG/$HOST:v1` is your release tag; `kheeper.com/public/postgres:v0.1.0` is the image it's built from.
